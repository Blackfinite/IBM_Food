          ...
          {(showAll ? initialData : initialData.slice(0, 4)).map(
            (item, index) => {
              ...
              return (
                <div
                  key={`${item.id}-${index}`}
                  className="relative group bg-[#2b4437] rounded-5xl hover:shadow-green-900/40 border-2 border-transparent hover:border-green-500/20 before:absolute before:inset-0 hover:before:opacity-20"
                >
